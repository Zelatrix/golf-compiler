...
class Function:
   def __init__(self, builder, module, fn_name, fn_body):
       self.builder = builder
       self.module = module
   ...
   def accept(self, visitor):
       visitor.visit_fun(self.fn_name, self.fn_body) # self.fn_params

# Functions with arguments
class FuncArgs:
   def __init__(self, builder, module, fn_name, fn_args, fn_body):
       self.builder = builder
       self.module = module
       self.fn_name = fn_name
       self.fn_body = fn_body
   ...
   def accept(self, visitor):
       visitor.visit_fargs(self.fn_name, self.fn_args, self.fn_body)
