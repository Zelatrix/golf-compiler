...
class Lexer:
    ...
    def add_tokens(self):
        # Type declarations
        self.lexer.add("TY_INT", r"int")
        self.lexer.add("TY_FLOAT", r"float")
        self.lexer.add("TY_BOOL", r"bool")
        self.lexer.add("TY_STRING", r"string")
        self.lexer.add("TY_CHAR", r"char")
        self.lexer.add("TY_VOID", r"void")
        self.lexer.add("RET_TY", r"\-\>")
        ...
        self.lexer.add("PRINTSTR", r"(printstr)")
