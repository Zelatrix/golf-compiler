...
loop_start:
  ...
  %".8" = fcmp olt double %".7", 0x4024000000000000
...
loop_start.if:
  ...
  %".13" = fcmp olt double %".12", 0x4024000000000000
...
loop_start.1:
  ...
  %".18" = fcmp olt double %".17", 0x4024000000000000
...
loop_start.1.if:
  ...
  %".23" = fcmp olt double %".22", 0x4024000000000000
  ...
  %".30" = fadd double %".29", 0x3ff0000000000000
  store double %".30", double* %".4"
  br label %"loop_start.1"
loop_start.1.endif:
  %".33" = load double, double* %".2"
  %".34" = fadd double %".33", 0x3ff0000000000000
